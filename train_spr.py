...
from utils.architecture.SPR.models import SPRCatDqnModel
from utils.architecture.SPR.rlpyt_utils import OneToOneSerialEvalCollector, SerialSampler, MinibatchRlEvalWandb
from agents.spr_agent import SPRCategoricalDQN
from agents.spr_agent import SPRAgent
from utils.architecture.SPR.rlpyt_atari_env import AtariEnv
from utils.utils_spr import set_config
...
if __name__ == "__main__":
    ...
    parser.add_argument('--wandb-dir', type=str, default='log', help='Directory for wandb files.')
    ...
    parser.add_argument('--project', type=str, default="Sandbox-SRL")
    parser.add_argument('--entity', type=str, default="rl0708")
