...
import utils.dmc2gym.natural_img_source as natural_img_source
...
class DMCWrapper(core.Env):
    def __init__(
        ...
        if img_source is not None:
            ...
            if img_source == "color":
                self._bg_source = natural_img_source.RandomColorSource(shape2d)
            elif img_source == "noise":
                self._bg_source = natural_img_source.NoiseSource(shape2d)
            else:
                ...
                if img_source == "images":
                    self._bg_source = natural_img_source.RandomImageSource(shape2d, files, grayscale=True, total_frames=total_frames)
                elif img_source == "video":
                    self._bg_source = natural_img_source.RandomVideoSource(shape2d, files, grayscale=True, total_frames=total_frames)
                else:
