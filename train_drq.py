...
from utils.architecture.DrQ.replay_buffer import ReplayBuffer
import utils.utils_drq as utils
from utils.utils_drq import Logger, VideoRecorder
...
@hydra.main(config_path='config/DRQ', config_name="config_drq.yaml")
def main(cfg):
    from train_drq import Workspace as W
    workspace = W(cfg)
    workspace.run()
